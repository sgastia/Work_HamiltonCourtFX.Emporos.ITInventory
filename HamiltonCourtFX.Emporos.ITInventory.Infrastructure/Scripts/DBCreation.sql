...
/****** Object:  Database [ITInventory]    Script Date: 25-Apr-24 07:46:59 ******/
CREATE DATABASE [ITInventory]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ITInventory', FILENAME = N'E:\MSSQLSERVER_DEV--Data\ITInventory.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ITInventory_log', FILENAME = N'E:\MSSQLSERVER_DEV--Data\ITInventory_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [ITInventory] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [ITInventory] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [ITInventory] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [ITInventory] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [ITInventory] SET QUERY_STORE = ON
GO

ALTER DATABASE [ITInventory] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
